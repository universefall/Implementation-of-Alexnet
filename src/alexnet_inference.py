# -*- coding: utf-8 -*-
"""
用于1000个分类的Alexnet网络测试，该版本去掉了LRN，后续的论文指出LRN对网络表现提升不大(奥卡姆剃刀)

1.增加了AdaptiveAvgPool2d，对图片卷积图进行自适应池化，方便输入FC层
2.改变了卷积核数量:conv1, conv2, conv3, conv4, conv5 
                  ->64,  192,    384,   256,   256
...
def process_img(path_img):
    ...
    # transform对图片进行预处理，resize到256，然后中心裁剪到224
    ...
    img_tensor.unsqueeze_(0)        # chw --> bchw 为tensor增加一个batch的维度
...
if __name__ == "__main__":
    ...
    # topk找出前k大的value和对应的key值，此处为前5项error:
